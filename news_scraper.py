...
NEWS_SITES = [
    ...
    },
    {
        ...
        "article_selector": ".sc-eKtvVk, .sc-jNAVZO, .sc-bDuHIP",
        "title_selector": ".sc-hoXqvr, .sc-hgZGjk, h1",
        "summary_selector": ".sc-dYOqWG, .sc-APcvf",
        "content_container": "main",
        "content_selector": "p.sc-dYOqWG",
        "exclude_selectors": [".sc-ghzrUh", ".ad-trailer", ".sc-leQnM", "footer"],
    ...
    },
    {
        ...
        "url": "https://ici.radio-canada.ca/ontario/nord-de-l-ontario",
        "article_selector": ".sc-eKtvVk, .sc-jNAVZO, .sc-bDuHIP",
        "title_selector": ".sc-hoXqvr, .sc-hgZGjk, h1",
        "summary_selector": ".sc-dYOqWG, .sc-APcvf",
        "content_container": "main",
